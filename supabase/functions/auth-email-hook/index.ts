...
const EMAIL_SUBJECTS: Record<string, string> = {
  ...
  invite: 'Du har bjudits in till Parium',
  magiclink: 'Din inloggningslänk till Parium',
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  console.log('Received auth event', { emailType, hasEmail: !!payload.data.email, run_id })
