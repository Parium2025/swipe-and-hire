// Server-only. Krypterar och dekrypterar kopplingsnycklar (lovack_*) som
// lagras i app_user_connections. Lovable tillhandahåller nyckeln automatiskt
// som APP_USER_CONNECTION_KEY_SECRET när en App User Connector är länkad.
