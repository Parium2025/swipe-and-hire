// Server-only. App User Connector-hjälp: starta per-användare OAuth mot
// Lovable-kopplingsgatewayen och gör autentiserade provider-anrop å den
// inloggade användarens vägnar. Läs aldrig dessa värden i webbläsarkod.
