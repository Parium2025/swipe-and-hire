CREATE OR REPLACE FUNCTION public.get_employer_analytics_v2(p_user_id uuid, p_days_back integer DEFAULT NULL)
 RETURNS json
 LANGUAGE plpgsql
...
BEGIN
  ...
  WITH org_job_ids AS (
    SELECT jp.id, jp.created_at as job_created_at
