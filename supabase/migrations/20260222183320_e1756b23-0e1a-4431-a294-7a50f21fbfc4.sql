...
-- Add city to the return type of get_applicant_profile_media_batch
DROP FUNCTION IF EXISTS get_applicant_profile_media_batch(uuid[], uuid);

CREATE OR REPLACE FUNCTION get_applicant_profile_media_batch(
