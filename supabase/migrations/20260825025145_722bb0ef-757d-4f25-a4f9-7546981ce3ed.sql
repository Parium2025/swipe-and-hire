...
REVOKE EXECUTE ON FUNCTION public.get_employer_analytics_v2(uuid, integer) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.get_employer_analytics_v2(uuid, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_employer_analytics_v2(uuid, integer) TO service_role;