...
BEGIN
  ...
  RETURN QUERY SELECT * FROM public.search_employer_candidates(p_search := NULL, p_limit := 5);
END;
$$;

GRANT EXECUTE ON FUNCTION public.test_search_employer_candidates() TO authenticated, anon;