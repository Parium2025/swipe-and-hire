...
BEGIN
  ...
  -- Alla organisationens annonser (inte bara de publicerade i perioden) så att
  -- visningar/ansökningar i perioden på äldre annonser också räknas per kollega.
  org_jobs AS (
  ...
  i AS (
    SELECT iv.employer_id, count(*)::int AS interviews
