CREATE UNIQUE INDEX IF NOT EXISTS uq_odl_job_closed_once
  ON public.outreach_dispatch_logs (automation_id, recipient_user_id, job_id)
  WHERE trigger = 'job_closed' AND recipient_user_id IS NOT NULL AND automation_id IS NOT NULL;

CREATE UNIQUE INDEX IF NOT EXISTS uq_odl_application_received_once
  ON public.outreach_dispatch_logs (automation_id, recipient_user_id, (payload->>'application_id'))
  WHERE trigger = 'application_received' AND recipient_user_id IS NOT NULL AND automation_id IS NOT NULL;
