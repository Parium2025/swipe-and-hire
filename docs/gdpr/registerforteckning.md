...
- **Lagringstid:** Så länge kontot är aktivt. Efter 24 månaders inaktivitet: varningsmejl + påminnelser (180, 90 och 7 dagar kvar) + radering efter 365 dagar. Radering på egen begäran sker omedelbart.
