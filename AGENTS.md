...
- Mobile shells keep a stable `100dvh` frame and compensate only Safari's visual-viewport top offset while the keyboard is open; focused fields move only inside existing scroll areas, and browser-color strips never cover form content.
