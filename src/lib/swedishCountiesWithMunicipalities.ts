// Swedish counties with their municipalities
export const swedishCountiesWithMunicipalities = {
  "Blekinge län": [
  ...
  "Jönköpings län": [
    ...
    "Mullsjö", "Nässjö", "Sävsjö", "Tranås", "Vaggeryd", "Vetlanda", "Värnamo"
  ],
  "Kalmar län": [
  ...
  "Norrbottens län": [
    "Arjeplog", "Arvidsjaur", "Boden", "Gällivare", "Haparanda", "Jokkmokk", 
...
export type CountyName = keyof typeof swedishCountiesWithMunicipalities;
