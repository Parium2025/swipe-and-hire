...
export const OCCUPATION_ALIASES: OccupationAlias[] = [
  ...
  // ─── Butik / försäljning ────────────────────────────────
  { alias: 'butiksbiträde', canonical: 'Butikssäljare, fackhandel' },
  { alias: 'butikssäljare', canonical: 'Butikssäljare, fackhandel' },
  { alias: 'butikspersonal', canonical: 'Butikssäljare, fackhandel' },
  ...
  { alias: 'rörmokare', canonical: 'VVS-montör' },
  { alias: 'vvs', canonical: 'VVS-montör' },
  { alias: 'vvs-montör', canonical: 'VVS-montör' },
