...
const Auth = () => {
  ...
  const { signIn, signUp, signInWithGoogle, user, resendConfirmation, resetPassword, updatePassword } = useAuth();
                      ...
                      <>
                        ...
                        <div className="mb-6">
                          <Button 
                            ...
                            variant="outline"
                            className="w-full flex items-center gap-3 py-6 bg-white hover:bg-gray-50 text-gray-700 border-gray-300 hover:border-gray-400 transition-all duration-200"
                            disabled={loading}
                          >
                            ...
                            {loading ? 'Ansluter...' : 'Fortsätt med Google'}
                          </Button>
