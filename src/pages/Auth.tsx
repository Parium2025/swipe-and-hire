                ...
                <div className="max-w-lg animate-fade-in">
                  ...
                  <div className="mb-8">
                    <div className="relative">
                      <div className="absolute inset-0 blur-2xl bg-secondary/50 rounded-full animate-pulse"></div>
                      <div className="absolute inset-0 blur-lg bg-accent/30 rounded-full"></div>
                      <img 
                        src="/lovable-uploads/3e52da4e-167e-4ebf-acfb-6a70a68cfaef.png" 
                        alt="Parium" 
                        className="relative h-16 w-auto brightness-125 contrast-110 drop-shadow-lg"
                      />
                    </div>
                  </div>
                        ...
                        <CardHeader className="text-center pb-6 pt-8">
                          <div className="mb-6">
                            <div className="relative mx-auto w-fit">
                              ...
                              <div className="absolute inset-0 blur-md bg-accent/25 rounded-full"></div>
                              <img 
                                src="/lovable-uploads/3e52da4e-167e-4ebf-acfb-6a70a68cfaef.png" 
                                alt="Parium" 
                                className="relative h-14 w-auto brightness-125 contrast-110 drop-shadow-lg"
                              />
                            </div>
                          </div>
