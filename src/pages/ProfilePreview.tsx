              ...
              {consentedData?.phone && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p 
                      className="text-white cursor-pointer transition-opacity hover:opacity-80 text-sm"
                      onClick={handlePhoneClick}
                    >
                      {consentedData.phone}
                    </p>
              ...
              {consentedData?.location && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">{consentedData.location}</p>
                  </div>
                </div>
              )}
              {user?.email && (
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                {consentedData?.working_hours && (
                  <div>
                    ...
                    <p className="text-white text-sm">{getWorkingHoursLabel(consentedData.working_hours)}</p>
                  </div>
                )}
                {consentedData?.availability && (
                  <div>
                    <p className="text-[10px] text-white/60 mb-0.5">Tillgänglighet</p>
                    <p className="text-white text-sm">{getAvailabilityLabel(consentedData.availability)}</p>
                  </div>
                )}
              </CardContent>
            </Card>
