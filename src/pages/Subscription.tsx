        ...
        <div className="space-y-4 mb-6">
          ...
          {plans.map((plan) => {
            ...
            return (
              <Card 
                key={plan.id}
                className={`relative bg-blue-500/10 backdrop-blur-sm border-blue-500/20 ${plan.recommended ? 'border-blue-400/50' : ''} ${isCurrent ? 'border-green-400/50 bg-green-500/10' : ''}`}
              >
                {plan.recommended && (
