...
const SavedJobs = () => {
  ...
  if (!showContent) {
    return (
      <div className="responsive-container-wide opacity-0 pb-page-bottom" aria-hidden="true">
  ...
  return (
    <div className="responsive-container-wide animate-fade-in pb-page-bottom">
      <div className="text-center mb-5">
