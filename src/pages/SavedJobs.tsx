...
const SavedJobs = () => {
  ...
  if (!showContent) {
    return (
      <div className="responsive-container-wide opacity-0 [padding-bottom:calc(env(safe-area-inset-bottom,0px)+6rem)]" aria-hidden="true">
  ...
  return (
    <div className="responsive-container-wide animate-fade-in [padding-bottom:calc(env(safe-area-inset-bottom,0px)+6rem)]">
      <div className="text-center mb-5">
