    ...
    >
      <div className="mx-auto grid h-full w-full max-w-[1280px] grid-cols-[1.15fr_0.85fr] items-center gap-3 sm:gap-6 md:gap-10 lg:grid-cols-2 lg:gap-16 2xl:max-w-[1440px]">
        ...
        <div
          ...
          className={`${visible && phoneReady ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0'} relative mx-auto flex h-full w-full translate-y-[7svh] items-center justify-center transition-opacity duration-500 ease-out sm:translate-y-[6svh] md:translate-y-[5svh] lg:translate-y-0`}
          style={{ touchAction: 'none', overscrollBehavior: 'contain' }}
        >
          <SplinePhone
            className="aspect-[9/19.5] h-[clamp(180px,34vw,250px)] w-auto sm:h-[clamp(230px,32vw,340px)] md:h-[clamp(300px,31vw,430px)] lg:h-[min(68svh,32vw,660px)]"
            zoom={0.78}
            active={active}
          />
        </div>
