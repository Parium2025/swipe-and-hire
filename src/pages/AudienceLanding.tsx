                  ...
                  ? [
                      {
                        ...
                        a: 'Parium kopplar ihop arbetsgivare och jobbsökare i en och samma plattform. En arbetsgivare publicerar en annons som är aktiv i 14 dagar. Du hittar enkelt de roller som passar dig, swipar i mobilen eller bläddrar i listan på datorn och anmäler ditt intresse. Vissa arbetsgivare ställer några korta frågor innan du skickar in.',
                      },
                      {
                        q: 'Vad kostar det?',
                      ...
                      },
                      {
                        ...
                        a: 'Allt från lokala butiker och caféer till växande techbolag och etablerade arbetsgivare runt om i Sverige. Vi lägger till nya företag löpande och prioriterar arbetsgivare som svarar snabbt, med hög kvalitet på sina annonser.',
                      },
                      {
                        q: 'Vad händer när jag visat intresse för ett jobb?',
                        a: 'Arbetsgivaren ser din profil med bild eller video och dina svar på eventuella frågor i annonsen. Ser arbetsgivaren att du verkar vara rätt match kan de öppna en chatt direkt i appen, där ni kan prata vidare, ställa frågor och boka intervju.',
                      },
                      {
                      ...
                      },
                      {
                        ...
                        a: 'Spara en sökning med dina önskemål kring roll, ort och erfarenhet. När en ny annons stämmer med sökningen hör vi av oss direkt — i mobilappen som en notis på låsskärmen, och i webbläsaren via klockan uppe i menyn. Så missar du aldrig ett relevant jobb.',
                      },
                      {
