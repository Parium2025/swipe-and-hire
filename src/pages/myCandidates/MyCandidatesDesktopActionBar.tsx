  ...
  return (
    <div className="hidden md:flex fixed bottom-6 left-0 right-0 z-50 animate-in slide-in-from-bottom-4 duration-300 px-4 justify-center">
      <div className="flex items-center gap-1.5 bg-card-parium/95 backdrop-blur-md border border-white/20 rounded-full px-3 py-2 shadow-xl overflow-hidden min-w-0 max-w-full">
        <span className="text-white text-xs font-medium whitespace-nowrap shrink-0">
        ...
        <button
          ...
          className="flex items-center justify-center px-2 h-8 text-xs whitespace-nowrap shrink-0 w-[90px] text-white md:hover:bg-white/10 outline-hidden focus:outline-hidden transition-all duration-200 rounded-md"
        >
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
              ...
              onMouseDown={(e) => e.preventDefault()}
              className={`flex items-center px-2 h-8 text-xs whitespace-nowrap shrink-0 outline-hidden focus:outline-hidden md:hover:bg-white/10 md:hover:text-white transition-all duration-200 rounded-md ${
        ...
        <button
          ...
          onMouseDown={(e) => e.preventDefault()}
          className={`flex h-8 shrink-0 items-center rounded-md px-2 text-xs whitespace-nowrap outline-hidden focus:outline-hidden transition-all duration-200 ${
