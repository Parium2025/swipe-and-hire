      ...
      {isEditing ? (
        <>
          <Input
            ...
            className="h-9 rounded-full text-base bg-white/5 border-white/20 text-white focus:outline-hidden focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
          />
          <button
            onClick={onSaveEdit}
            aria-label="Spara namn"
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-white bg-white/10 transition-colors md:hover:bg-white/20 focus:outline-hidden focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
          >
        ...
        <>
          {canReorder && (
            <div
              ...
              {...attributes}
              {...listeners}
              className="flex h-9 w-9 shrink-0 cursor-grab touch-none select-none items-center justify-center rounded-full text-white transition-colors active:cursor-grabbing md:hover:bg-white/10 focus:outline-hidden focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
            >
          ...
          <button
            ...
            className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full border transition-colors focus:outline-hidden focus:ring-0 focus-visible:ring-0 ${
              list.is_default
  ...
  return (
    <>
        ...
        <DialogContent className="bg-card-parium border-white/20 rounded-3xl max-w-md">
          ...
          <div className="flex items-center gap-2 pt-1">
            <Input
              ...
              disabled={atLimit}
              className="h-11 rounded-full px-5 text-base bg-white/5 border-white/20 text-white placeholder:text-white/70 focus:outline-hidden focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
            />
            <button
              onClick={handleCreate}
              disabled={atLimit || !newName.trim() || busy}
              className={`flex h-11 shrink-0 items-center gap-1.5 rounded-full px-5 text-sm font-medium text-white ring-1 ring-inset transition-all active:scale-[0.97] touch-manipulation focus:outline-hidden focus:ring-0 focus-visible:ring-0 ${
      ...
      <AlertDialog open={!!pendingDelete} onOpenChange={() => setPendingDelete(null)}>
        <AlertDialogContentNoFocus className="border-white/20 text-white w-[calc(100vw-2rem)] max-w-[calc(100vw-2rem)] sm:max-w-md sm:w-[28rem] p-4 sm:p-6 bg-white/10 backdrop-blur-xs rounded-xl shadow-lg mx-0 max-h-[90dvh] flex flex-col outline-hidden focus:outline-hidden focus-visible:outline-hidden focus:ring-0 focus-visible:ring-0 focus:ring-offset-0 focus-visible:ring-offset-0 [-webkit-tap-highlight-color:transparent]">
          ...
          <AlertDialogFooter className="flex-row gap-2 sm:justify-center shrink-0">
            ...
            <AlertDialogAction
              ...
              className="btn-dialog-action flex-1 text-sm flex items-center justify-center rounded-full !outline-hidden !ring-0 !ring-offset-0 focus:!outline-hidden focus:!ring-0 focus:!ring-offset-0 focus-visible:!outline-hidden focus-visible:!ring-0 focus-visible:!ring-offset-0 active:!outline-hidden [-webkit-tap-highlight-color:transparent]"
            >
