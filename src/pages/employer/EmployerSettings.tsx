        ...
        <div className="space-y-5 md:space-y-3">
          <div className="space-y-1.5">
            ...
            <Input 
              ...
              value={user?.email || ''} 
              disabled 
              className="bg-white/5 border-white/10 text-white/70 h-9 text-sm cursor-not-allowed hover:border-white/50"
            />
          </div>
        </div>
      </div>
        ...
        <div className="space-y-5 md:space-y-3">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="bg-white/5 border-white/10 text-white placeholder:text-white/40 h-9 text-sm hover:border-white/50"
            />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="flex justify-center pt-1">
            <Button onClick={handlePasswordUpdate} className="h-9 px-6 text-sm border border-white/30 text-white font-medium transition-all duration-300 md:hover:bg-white/10 md:hover:border-white/50 md:hover:text-white [&_svg]:text-white md:hover:[&_svg]:text-white">
              Uppdatera lösenord
            </Button>
          </div>
        </div>
