      ...
      <div className="flex flex-col items-center space-y-4 py-6">
        ...
        <div className="flex gap-2">
          <Button 
            ...
            className="bg-white/5 border-white/10 text-white/90 hover:bg-white/10 text-xs"
          >
            {isUploadingLogo ? (
              <>
          ...
          {formData.company_logo_url && (
            <Button 
              ...
              disabled={isUploadingLogo}
              className="bg-white/5 border-white/10 text-white/90 hover:bg-red-500/20 text-xs"
            >
