          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {jobCategories.map((category) => (
              <DropdownMenu key={category.value}>
                ...
                <DropdownMenuContent 
                  className="min-w-[var(--radix-dropdown-menu-trigger-width)] max-h-80 overflow-y-auto bg-slate-700/90 backdrop-blur-md border-slate-500/30 shadow-xl z-50 rounded-lg text-white"
                  side="bottom"
                  align="start"
                  alignOffset={0}
                  sideOffset={6}
