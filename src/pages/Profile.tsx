            ...
            {(isProfileVideo && !!profileImageUrl) && (
              <div className="flex flex-col items-center space-y-3 mt-4 p-4 rounded-lg bg-white/5 w-full">
                <Button 
                  ...
                  className="bg-white/5 backdrop-blur-sm border-white/10 text-white disabled:opacity-50 hover:bg-white/10 md:hover:bg-white/10 md:hover:text-white md:hover:border-white/10"
                >
          ...
          <div className="p-6 md:p-4">
            <form onSubmit={handleSubmit} className="space-y-6 md:space-y-3">
              ...
              <div className="flex justify-center">
                <Button 
                  type="submit" 
                  className="bg-white/5 backdrop-blur-sm border border-white/10 text-white disabled:opacity-50 disabled:cursor-not-allowed font-medium h-9 px-6 text-sm hover:bg-white/10 md:hover:bg-white/10 [&_svg]:text-white" 
                  disabled={loading}
                >
