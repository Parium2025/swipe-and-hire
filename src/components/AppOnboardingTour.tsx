...
const AppOnboardingTour = ({ onComplete }: AppOnboardingTourProps) => {
  ...
  return (
    <>
      ...
      <div className={`fixed z-50 onboarding-tour ${cardPos ? '' : 'top-1/2 left-1/2 transform -translate-y-1/2'}`} style={cardPos ? { top: cardPos.top, left: cardPos.left, transform: 'translateX(-50%)' } : { transform: 'translate(-70%, -50%)' }}>
