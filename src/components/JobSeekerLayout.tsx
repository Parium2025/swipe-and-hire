...
const JobSeekerLayout = memo(({ children, developerView, onViewChange }: JobSeekerLayoutProps) => {
    ...
    return (
      <>
        ...
        <div className="min-h-screen flex flex-col w-full overflow-x-hidden relative">
          ...
          <main className="flex-1 overflow-x-hidden overflow-y-auto p-3 relative z-10">
            {children}
          </main>
  ...
  return (
    <SidebarProvider defaultOpen={true}>
      ...
      <div className="h-[100dvh] flex w-full overflow-hidden relative" style={{ WebkitOverflowScrolling: 'touch', backgroundColor: 'hsl(215 100% 12%)' }}>
        <AnimatedBackground showBubbles={false} />
        <AppSidebar />
        <div className="flex-1 flex flex-col overflow-hidden relative z-10" style={{ backgroundColor: 'transparent' }}>
