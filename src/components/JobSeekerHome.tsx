...
const JobSeekerHome = memo(() => {
  ...
  return (
    <>
      ...
      <div className="space-y-3 sm:space-y-6 responsive-container-wide py-2 sm:py-3 animate-fade-in relative z-10 [padding-bottom:calc(env(safe-area-inset-bottom,0px)+6rem)]">
        {/* Personal greeting */}
        <motion.div
