  ...
  return (
    <>
      <div className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden">
        <Table>
          <TableHeader>
            <TableRow className="border-white/10 md:hover:bg-white/5">
          ...
          <TableBody>
            {applications.map((application) => {
              ...
              return (
                <TableRow
                  key={application.id}
                  className="border-white/10 md:hover:bg-white/5 cursor-pointer transition-all duration-150 active:bg-white/10 active:scale-[0.99]"
