          ...
          <div className="text-center mb-8">
            <div className="mb-4">
              <div className="relative mx-auto w-fit">
                {/* Glow effect bakom loggan - kompakt och koncentrerad */}
                <div className="absolute inset-0 flex items-center justify-center -translate-y-2">
                  <div className="w-44 h-44 bg-primary-glow/50 rounded-full blur-[50px]"></div>
                </div>
                <div className="absolute inset-0 flex items-center justify-center -translate-y-2">
                  <div className="w-32 h-32 bg-primary-glow/40 rounded-full blur-[40px]"></div>
                </div>
                <img 
