                              ...
                              <div>
                                ...
                                <DropdownMenu modal={false} open={industryMenuOpen} onOpenChange={setIndustryMenuOpen}>
                                   <DropdownMenuTrigger asChild>
                                    ...
                                    <DropdownMenuContent 
                                     className="w-80 bg-[hsl(215,100%,12%)]/80 backdrop-blur-xl border-white/20 shadow-lg z-[9999] rounded-md text-white overflow-hidden max-h-96"
                                     side="bottom"
                                     align="center"
                                     alignOffset={0}
                                     sideOffset={8}
                                     ...
                                     <div className="p-3 border-b border-white/20 sticky top-0 bg-transparent">
                                       ...
                                       <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-white/60" />
                                           <Input
                                            ...
                                            className="pl-10 pr-4 h-10 text-base bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:border-white/40 rounded-lg"
                                            autoComplete="off"
                                            autoCapitalize="none"
                                            autoCorrect="off"
