      ...
      <div className="relative z-10 flex flex-col min-h-screen py-safe animate-fade-in">
        ...
        <div className="flex flex-col items-center px-6 pt-6 pb-4">
          ...
          <div className="w-full max-w-md">
            <Card className="bg-white/[0.02] backdrop-blur-sm border-white/20 shadow-2xl rounded-2xl overflow-hidden">
                                     ...
                                     <div className="p-3 border-b border-white/20 sticky top-0 bg-transparent">
                                       ...
                                       <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-white/60" />
                                           <Input
                                            ...
                                            className="pl-10 pr-4 h-10 text-base bg-transparent border-white/20 text-white placeholder:text-white/60 focus:border-white/40 rounded-lg"
                                            autoComplete="off"
                                            autoCapitalize="none"
                                            autoCorrect="off"
