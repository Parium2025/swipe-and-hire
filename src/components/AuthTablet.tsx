  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0" style={{ paddingTop: 'var(--pwa-top-offset, 0px)' }}>
        ...
        {/* Decorative glow effect in bottom right corner (handled by AnimatedBackground) */}
                                ...
                                <DropdownMenu modal={false} open={industryMenuOpen} onOpenChange={setIndustryMenuOpen}>
                                  <DropdownMenuTrigger asChild>
                                    <Button
                                      ref={triggerRef}
                                      variant="outline"
                                      className="w-full bg-white/5 backdrop-blur-sm border-white/20 text-white md:hover:bg-white/10 transition-colors justify-between mt-1 text-left"
                                    >
                             ...
                             <div>
                               <Label htmlFor="companyDescription" className="text-white">Kort beskrivning</Label>
                                <Textarea
                                  ...
                                  className="mt-1 bg-white/5 backdrop-blur-sm border-white/20 text-white md:hover:bg-white/10 placeholder:text-white/60 resize-none"
                                  rows={2}
                                />
                             </div>
                           </div>
