            ...
            <div className="flex h-full">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="px-2 pb-2 md:px-4 md:pb-4">
                  <div 
                    className="text-lg md:text-xl font-bold text-center transition-opacity duration-500 flex justify-center text-green-400"
              ...
              {stat.subItems.map((item, idx) => {
                ...
                return (
                  <div key={idx} className="flex-1 flex flex-col border-l border-white/30">
                    ...
                    <div className="px-2 pb-2 md:px-4 md:pb-4">
                      <div className={`text-lg md:text-xl font-bold text-center flex justify-center ${colorClass}`}>
