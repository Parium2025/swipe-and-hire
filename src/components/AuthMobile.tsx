  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0" style={{ paddingTop: 'var(--pwa-top-offset, 0px)' }}>
        ...
        <div className="absolute top-20 left-10 w-4 h-4 bg-secondary/30 rounded-full animate-soft-bounce" style={{ animationDuration: '2s', animationFillMode: 'backwards' }}></div>
                                     ...
                                     <div className={`overflow-y-auto ${isMobile ? 'max-h-[calc(50vh-4rem)]' : 'max-h-80'} overscroll-contain`}>
                                        ...
                                        !SWEDISH_INDUSTRIES.some(industryOption => 
                                         ...
                                         <DropdownMenuItem
                                           ...
                                           className={`cursor-pointer hover:bg-white/10 focus:bg-white/10 ${isMobile ? 'py-2 px-4 text-sm' : 'py-2 px-3'} text-white border-t border-slate-600/30 transition-colors touch-manipulation`}
                                         >
