  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        {/* Animated floating elements matching parium.se */}
        {/* Top left area */}
        <div className="absolute top-28 left-8 w-3 h-3 bg-secondary/25 rounded-full animate-bounce" style={{ animationDuration: '2s' }}></div>
        <div className="absolute top-40 left-12 w-4 h-4 bg-accent/30 rounded-full animate-bounce" style={{ animationDuration: '2.5s' }}></div>
        <div className="absolute top-56 left-16 w-3 h-3 bg-secondary/20 rounded-full animate-bounce" style={{ animationDuration: '3s' }}></div>
        
        {/* Top right area */}
        <div className="absolute top-28 right-8 w-4 h-4 bg-accent/35 rounded-full animate-bounce" style={{ animationDuration: '2.2s' }}></div>
        <div className="absolute top-44 right-12 w-3 h-3 bg-secondary/30 rounded-full animate-pulse" style={{ animationDuration: '1.8s' }}></div>
        
        {/* Middle left area */}
        <div className="absolute top-72 left-6 w-2 h-2 bg-accent/40 rounded-full animate-bounce" style={{ animationDuration: '2.8s' }}></div>
        
        {/* Small accent dots */}
        <div className="absolute top-[30vh] left-24 w-1 h-1 bg-accent/50 rounded-full animate-pulse" style={{ animationDuration: '2.3s' }}></div>
        <div className="absolute top-[35vh] right-1/3 w-1 h-1 bg-secondary/60 rounded-full animate-pulse" style={{ animationDuration: '3s' }}>
          <div className="absolute inset-0 bg-secondary/40 rounded-full animate-ping" style={{ animationDuration: '3s' }}></div>
        </div>
      </div>
