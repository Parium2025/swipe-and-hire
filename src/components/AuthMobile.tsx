                ...
                <Tabs value={isLogin ? 'login' : 'signup'} onValueChange={(value) => setIsLogin(value === 'login')}>
                  ...
                  <TabsContent value="login">
                    ...
                    {showResend && (
                      <div className="mt-6 p-4 rounded-lg text-center">
                        <p className="text-sm mb-2 text-white">Kontrollera din e-post för att aktivera ditt konto.</p>
                        <Button 
                          size="sm" 
                  ...
                  <TabsContent value="signup">
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="mb-4">
                        <Label className="text-white mb-3 block">Vad söker du?</Label>
                        <RadioGroup value={role} onValueChange={(value: 'job_seeker' | 'employer') => setRole(value)} className="flex gap-4">
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="job_seeker" id="job_seeker" className="border-white/40" />
                            <Label htmlFor="job_seeker" className="text-white">Jobb</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="employer" id="employer" className="border-white/40" />
                            <Label htmlFor="employer" className="text-white">Kandidater</Label>
                          </div>
                        </RadioGroup>
                      </div>
                        ...
                        {password && (
                          <div className="mt-2">
                            ...
                            <p className="text-xs text-white/70 mt-1">
                              ...
                              {passwordStrength === 3 && 'Medel lösenord'}
                      ...
                      <Button type="submit" className="w-full py-3 text-lg" disabled={loading || passwordStrength < 3}>
