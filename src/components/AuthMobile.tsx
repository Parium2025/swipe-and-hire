  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0" style={{ paddingTop: 'var(--pwa-top-offset, 0px)', transform: 'translateY(var(--pwa-top-offset, 0px))' }}>
        ...
        <div className="fixed -right-32 bottom-0 w-96 h-96 pointer-events-none pwa-bottom-glow hidden md:block">
          ...
          <div className="text-center mb-4">
            <div className="-mb-6">
              <div className="relative mx-auto w-fit min-h-[200px] flex items-center justify-center">
                ...
                <div className="fixed left-1/2 top-[16vh] sm:top-[18vh] md:top-[20vh] lg:top-[22vh] -translate-x-1/2 -translate-y-2 pointer-events-none">
