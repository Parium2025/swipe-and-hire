          ...
          <div className="text-center mb-8">
            <div className="mb-2">
              <div className="relative mx-auto w-fit">
                ...
                <div aria-hidden="true" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full blur-[120px] bg-secondary/20 mix-blend-screen"></div>
                <img 
                  src="/lovable-uploads/79c2f9ec-4fa4-43c9-9177-5f0ce8b19f57.png" 
                  alt="Parium" 
                  className="relative h-40 w-auto mix-blend-screen"
                  width="400"
                  height="160"
                  loading="eager"
                  decoding="sync"
