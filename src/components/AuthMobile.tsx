  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        {/* Top left bubbles */}
        <div className="absolute top-8 left-8 w-3 h-3 bg-secondary/30 rounded-full animate-bounce" style={{ animationDuration: '2s' }}></div>
        <div className="absolute top-12 left-12 w-2 h-2 bg-accent/40 rounded-full animate-bounce" style={{ animationDuration: '2.5s' }}></div>
        <div className="absolute top-16 left-6 w-2 h-2 bg-secondary/20 rounded-full animate-bounce" style={{ animationDuration: '3s' }}></div>
        
        {/* Top right bubbles */}
        <div className="absolute top-10 right-8 w-4 h-4 bg-secondary/40 rounded-full animate-pulse" style={{ animationDuration: '1.5s' }}></div>
        <div className="absolute top-6 right-16 w-2 h-2 bg-accent/30 rounded-full animate-pulse" style={{ animationDuration: '2s' }}></div>
        <div className="absolute top-14 right-12 w-3 h-3 bg-accent/40 rounded-full animate-pulse" style={{ animationDuration: '1.8s' }}></div>
        
        {/* Middle right bubbles */}
        <div className="absolute top-1/4 right-10 w-3 h-3 bg-accent/35 rounded-full animate-bounce" style={{ animationDuration: '2.3s' }}></div>
        <div className="absolute top-1/3 right-6 w-2 h-2 bg-secondary/30 rounded-full animate-pulse" style={{ animationDuration: '2.8s' }}></div>
        
        {/* Bottom right bubbles */}
        <div className="absolute bottom-32 right-8 w-5 h-5 bg-accent/30 rounded-full animate-bounce" style={{ animationDuration: '2.2s' }}></div>
        <div className="absolute bottom-24 right-16 w-3 h-3 bg-secondary/25 rounded-full animate-bounce" style={{ animationDuration: '2.8s' }}></div>
        <div className="absolute bottom-28 right-12 w-2 h-2 bg-accent/35 rounded-full animate-bounce" style={{ animationDuration: '2.3s' }}></div>
        
        {/* Small stars scattered */}
        <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-accent/60 rounded-full animate-pulse" style={{ animationDuration: '3s' }}>
          <div className="absolute inset-0 bg-accent/40 rounded-full animate-ping" style={{ animationDuration: '3s' }}></div>
        </div>
        <div className="absolute top-1/3 right-1/4 w-1 h-1 bg-secondary/60 rounded-full animate-pulse" style={{ animationDuration: '2.5s' }}>
