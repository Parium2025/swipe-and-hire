          ...
          <div className="text-center mb-8">
            <div className="mb-2">
              <div className="relative mx-auto w-fit">
                ...
                <div aria-hidden="true" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 h-56 rounded-full bg-[radial-gradient(circle_at_center,hsl(var(--secondary)/0.5)_0%,hsl(var(--secondary)/0.2)_40%,transparent_70%)]"></div>
                <img 
