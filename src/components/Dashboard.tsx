          ...
          <div className="overflow-x-auto -mx-2">
            <Table>
              ...
              <TableBody>
                {isLoading ? (
                  <TableRow>
                    <TableCell colSpan={6} className="text-center text-white/60 py-8 text-xs md:text-sm">
                      Laddar...
                    </TableCell>
                  </TableRow>
                ) : jobs.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={7} className="text-center !text-white py-8 font-medium text-xs md:text-sm">
