      ...
      <div className="job-card-mobile-media relative w-full overflow-hidden">
        ...
        {showDeleteButton && (
          <button
            ...
            className="absolute top-2.5 right-2.5 flex h-9 w-9 items-center justify-center rounded-full border-0 bg-red-500/80 text-white transition-colors md:hover:!bg-red-500/90 md:hover:!text-white"
          >
       ...
       <div className="job-card-mobile-body space-y-2.5">
        ...
        <div className="flex items-center justify-center gap-1.5 flex-wrap">
          {job.employment_type && (() => {
            ...
            // Deltid med både dagar OCH pass → dela upp i två separata chips.
              ...
              return (
                <>
                  <Badge variant="glass" className="text-[11px] px-2 py-0.5 border-white/15 leading-snug inline-flex items-center text-white">
                    ...
                    <span className="leading-snug">{label} · {daysStr}</span>
                  </Badge>
                  <Badge variant="glass" className="text-[11px] px-2 py-0.5 border-white/15 leading-snug inline-flex items-center text-white">
                    <Clock className="h-3 w-3 mr-1 flex-shrink-0" />
                    <span className="leading-snug">{shiftsStr}</span>
                  </Badge>
                </>
              );
            }
