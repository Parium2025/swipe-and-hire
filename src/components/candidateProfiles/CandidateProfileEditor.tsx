                ...
                <div className="relative">
                  ...
                  {(hasVideo || hasImage) && (
                    <button
                      ...
                      className="absolute -top-3 -right-3 rounded-full border border-0 bg-red-500/80 p-2 text-white outline-none transition-colors [-webkit-tap-highlight-color:transparent] focus:ring-0 focus-visible:ring-0 md:hover:!bg-destructive/30"
                    >
              ...
              {cvUrl ? (
                <div className="flex min-h-11 items-center gap-2 rounded-md border border-white/10 bg-white/5 px-3 py-2">
                  ...
                  <button
                    ...
                    className="rounded-full border border-0 bg-red-500/80 p-2 text-white transition-colors md:hover:!bg-destructive/30"
                  >
                    <Trash2 className="h-4 w-4" />
                  </button>
                </div>
