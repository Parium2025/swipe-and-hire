...
const pickHeroSrc = () => {
  if (typeof window === 'undefined') return '/hero-video-720-v2.mp4';
  ...
  return desktop && !prefersLightweightVideo() && !prefersReducedData() ? '/hero-video-v2.mp4' : '/hero-video-720-v2.mp4';
};
    ...
    <div className="absolute inset-0 z-0 overflow-hidden">
      ...
      >
        <video
          ...
          poster="/hero-video-poster-v2.jpg"
