...
import desktopAsset from '@/assets/hero9-desktop.mp4.asset.json';
import landscapeLiteAsset from '@/assets/hero9-landscape-lite.mp4.asset.json';
import tabletAsset from '@/assets/hero8-tablet.mp4.asset.json';
import portraitAsset from '@/assets/hero8-portrait.mp4.asset.json';
import posterAsset from '@/assets/hero9-poster.jpg.asset.json';
