  ...
  return (
    <footer className="relative py-12 sm:py-16 px-5 sm:px-6 md:px-12 lg:px-24 border-t border-white/[0.04]" role="contentinfo">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col items-center md:items-start gap-2">
            <img
              src={pariumLogo}
              alt="Parium logotyp"
              className="h-auto w-24 md:w-32 opacity-50"
              loading="lazy"
              width={128}
              height={128}
            />
        ...
        <div className="mt-10 pt-6 border-t border-white/[0.04] flex flex-col sm:flex-row justify-between items-center gap-3 text-white/15 text-xs">
