...
export const audienceContent: Record<AudienceRole, AudienceContent> = {
  job_seeker: {
    ...
    features: [
      ...
      { title: 'Bli kontaktad direkt', description: 'Med premium får du tillgång till bolagets mejl och kan bli kontaktad direkt av arbetsgivaren.', icon: MessageCircle },
    ],
    proof: [
