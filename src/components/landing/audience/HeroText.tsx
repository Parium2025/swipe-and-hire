...
export const HeroText = ({ eyebrow, headline, subtitle, variant, headingId }: HeroTextProps) => {
  ...
  const headlineClass = isMobile
    ...
    : 'audience-ipad-heading mt-6 max-w-[min(92vw,60rem)] text-[clamp(2.75rem,5.2vw,7rem)] font-black leading-[1.04] tracking-[0] md:[@media_(orientation:landscape)_and_(min-width:900px)_and_(max-width:1180px)]:!text-[5.25rem] md:[@media_(orientation:landscape)_and_(min-width:900px)_and_(max-width:1180px)]:!leading-[1.0] md:[@media_(orientation:landscape)_and_(min-width:900px)_and_(max-width:1180px)]:!tracking-[0] md:[@media_(orientation:landscape)_and_(min-width:900px)_and_(max-width:1400px)]:text-[clamp(3.75rem,6.6vw,5.5rem)] md:[@media_(orientation:landscape)_and_(min-width:900px)_and_(max-width:1400px)]:leading-[1.02] md:[@media_(orientation:portrait)]:mx-auto md:[@media_(orientation:portrait)]:max-w-[min(88vw,52rem)] md:[@media_(orientation:portrait)]:text-[5.25rem] md:[@media_(orientation:portrait)]:leading-[1.0]';
