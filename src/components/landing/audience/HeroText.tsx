...
export const HeroText = ({ eyebrow, headline, subtitle, variant, headingId }: HeroTextProps) => {
  ...
  const subtitleClass = isMobile
    ...
    : 'wave-text mt-7 lg:[@media_(orientation:landscape)]:mt-24 xl:[@media_(orientation:landscape)]:mt-28 max-w-xl text-lg leading-8 font-medium md:[@media_(orientation:portrait)]:mx-auto md:[@media_(orientation:portrait)]:max-w-[min(82vw,46rem)]';
