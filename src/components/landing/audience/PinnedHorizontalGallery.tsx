    ...
    <>
      <style>{`
        ...
        @media (max-width: 767px) {
          /* Centrera rubriken vertikalt mellan nav och kort-stripen på mobil
             så det inte blir död yta ovanför titeln. */
          .phg-header { padding: clamp(180px, 26vh, 240px) 24px clamp(28px, 4vh, 48px); }
