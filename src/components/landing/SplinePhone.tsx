  ...
  return (
    ...
    >
      ...
      <canvas
        ...
        tabIndex={-1}
        className="absolute left-1/2 top-1/2 h-[170%] w-[190%] -translate-x-1/2 -translate-y-1/2 cursor-grab bg-transparent outline-none transition-opacity duration-500 active:cursor-grabbing lg:relative lg:left-auto lg:top-auto lg:h-full lg:w-full lg:translate-x-0 lg:translate-y-0"
        draggable={false}
