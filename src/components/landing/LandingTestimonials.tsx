        ...
        <div className="grid md:grid-cols-3 gap-5 sm:gap-6">
          {testimonials.map((t, i) => (
            <motion.blockquote
              ...
              className="relative p-7 sm:p-8 rounded-3xl border border-white/[0.05] bg-white/[0.015] hover:bg-white/[0.03] hover:border-white/[0.1] transition-all duration-500"
            >
              <div className="text-[hsl(250_60%_60%/0.3)] text-5xl font-serif leading-none mb-4" aria-hidden="true">"</div>
              <p className="text-white/50 text-sm leading-relaxed mb-6 italic">
                {t.quote}
              </p>
              <footer className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[hsl(250_60%_50%/0.3)] to-[hsl(200_80%_50%/0.3)] border border-white/[0.08] flex items-center justify-center text-white text-xs font-semibold">
                  {t.initials}
                </div>
                <div>
