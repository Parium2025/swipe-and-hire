        ...
        >
          <div className="flex w-full flex-col items-center gap-1.5 sm:gap-2">
            <motion.h1
              ...
              className="text-balance font-normal leading-[1.15] text-white opacity-100 drop-shadow-[0_2px_14px_rgb(0_0_0/0.55)] text-[clamp(1.6rem,7.2vw,3.25rem)] md:text-[clamp(3rem,6vw,4.75rem)]"
              style={{ color: '#ffffff' }}
            >
            ...
            <motion.p
              ...
              className="whitespace-nowrap max-w-[21rem] min-[390px]:max-w-[38rem] sm:max-w-none text-balance font-semibold leading-[1.1] tracking-tight text-white text-[clamp(1.12rem,calc(0.75vw+0.96rem),1.625rem)] md:text-[clamp(1.4rem,calc(1.4vw+0.8rem),1.9rem)]"
            >
