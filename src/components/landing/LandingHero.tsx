...
const LandingHero = ({ scrollContainerRef: _scrollContainerRef }: LandingHeroProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none relative z-10 mx-auto flex min-h-[100svh] max-w-[1180px] flex-col items-center justify-end px-5 pb-[14svh] pt-24 text-center sm:px-6 sm:pb-[12svh] sm:pt-28 md:px-12 md:pb-[18svh] lg:px-24 lg:pb-[22svh] xl:pb-[26svh]"
