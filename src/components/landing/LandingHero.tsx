...
const LandingHero = ({ scrollContainerRef: _scrollContainerRef }: LandingHeroProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none relative z-10 mx-auto flex min-h-[100svh] max-w-[1180px] flex-col items-center justify-end px-5 pb-[8svh] pt-24 text-center sm:px-6 sm:pb-[10svh] sm:pt-28 md:px-12 md:pb-[10svh] lg:px-24 lg:pb-[12svh] xl:pb-[14svh]"
      ...
      >
        ...
        <motion.p
          ...
          className="mt-6 max-w-[min(88vw,56rem)] font-normal leading-[1.32] text-white opacity-100 drop-shadow-[0_2px_14px_rgb(0_0_0/0.55)]"
          style={{ color: '#ffffff', fontSize: 'clamp(1.25rem, 0.9vw + 0.85rem, 2.25rem)' }}
        >
