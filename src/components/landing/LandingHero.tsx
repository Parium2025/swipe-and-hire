...
const MatchPreview = () => (
  <motion.div
    className="relative mx-auto h-[31rem] w-full max-w-[34rem] overflow-visible sm:h-[34rem]"
    initial={{ opacity: 0, y: 28, scale: 0.96 }}
    animate={{ opacity: 1, y: 0, scale: 1 }}
    transition={{ duration: 0.85, ease, delay: 0.15 }}
  >
    <div
      className="pointer-events-auto absolute -inset-x-16 -inset-y-10 z-0 opacity-100 sm:-inset-x-24 sm:-inset-y-12 lg:-inset-x-32 lg:-inset-y-16"
      style={{
        WebkitMaskImage: 'radial-gradient(ellipse at 56% 50%, black 0%, black 52%, transparent 72%)',
        maskImage: 'radial-gradient(ellipse at 56% 50%, black 0%, black 52%, transparent 72%)',
      }}
    >
