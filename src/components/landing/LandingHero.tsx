    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="mt-6 max-w-[min(92vw,64rem)] font-normal leading-[1.32] text-white opacity-100 drop-shadow-[0_2px_14px_rgb(0_0_0/0.55)]"
          style={{ color: '#ffffff', fontSize: 'clamp(1.25rem, 1.35vw + 0.55rem, 3rem)' }}
        >
