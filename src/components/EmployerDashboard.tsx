                          ...
                          <div className="flex flex-col items-center gap-0.5">
                            {job.is_active ? (
                              isJobExpiredCheck(job.created_at, job.expires_at) ? (
                                <Badge variant="glassDestructive" className="px-1 whitespace-nowrap text-sm transition-all duration-300 group-hover:backdrop-brightness-90 hover:bg-red-500/30 hover:backdrop-brightness-110">
                                  Utgången
                                </Badge>
                              ) : (
