  ...
  return (
    <div className="fixed inset-0 z-50 bg-primary flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
        {/* Logo */}
        <div className={`-mb-6 transform transition-all duration-1000 ease-out ${
          phase === 'loading' 
        ...
        <div className={`transform transition-all duration-1000 delay-500 ease-out ${
          ...
          <p className="text-center text-xl lg:text-2xl font-medium leading-tight relative z-10 text-white">
