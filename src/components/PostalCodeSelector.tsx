    ...
    <div className={className}>
      ...
      <div className="relative mt-1.5">
        ...
        <Input
          ...
          className="h-9 pl-10 text-sm bg-white/5 backdrop-blur-sm border-white/10 text-white hover:bg-white/10 hover:border-white/50 md:hover:border-white/50 placeholder:text-white/40"
          maxLength={6}
          autoComplete="off"
        />
        {isLoading && (
