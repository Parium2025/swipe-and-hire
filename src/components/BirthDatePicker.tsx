    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          variant="outline"
          className={cn(
            "w-full h-10 pl-3 pr-3 text-left font-normal bg-white/5 backdrop-blur-sm border-white/10 text-white hover:bg-white/10 md:hover:bg-white/10 justify-start",
