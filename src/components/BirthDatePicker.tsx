...
export function BirthDatePicker({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-auto p-0 bg-slate-900/85 backdrop-blur-xl border border-white/20 rounded-xl shadow-xl z-50" align={popoverAlign ?? "center"} alignOffset={(computedOffset ?? (popoverAlignOffset ?? -150))} side="bottom" sideOffset={8} avoidCollisions={false}>
        <div className="p-3 space-y-3">
          ...
          <Calendar
            ...
            initialFocus
            className="p-0 pointer-events-auto text-white [&_.rdp-caption]:text-white [&_.rdp-nav_button]:text-white [&_.rdp-nav_button]:border-white/30 [&_.rdp-nav_button:hover]:bg-white/10 [&_.rdp-nav_button:hover]:text-white/70"
            classNames={{
