...
export function BirthDatePicker({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-auto p-0 bg-primary backdrop-blur-sm border-primary/30 rounded-xl shadow-xl z-50" align="center" alignOffset={-130} side="bottom" sideOffset={8} avoidCollisions={false}>
