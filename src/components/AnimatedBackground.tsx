    ...
    <div className="fixed inset-0 pointer-events-none z-0">
      {showBubbles && (
        <>
          ...
          <div className="absolute top-32 left-16 lg:left-[320px] w-2 h-2 bg-accent/40 rounded-full animate-soft-bounce" style={{ animationDuration: '2.5s', animationDelay: '-1.2s', animationFillMode: 'backwards' }}></div>
          <div className="absolute top-24 left-20 lg:left-[340px] w-3 h-3 bg-secondary/20 rounded-full animate-soft-bounce" style={{ animationDuration: '3s', animationDelay: '-2.1s', animationFillMode: 'backwards' }}></div>
          ...
          <div className="absolute top-12 left-8 lg:left-[300px] w-3 h-3 bg-accent/40 rounded-full animate-pulse" style={{ animationDuration: '1.8s', animationDelay: '-0.7s', animationFillMode: 'backwards' }}></div>
          
          {/* Small stars */}
          <div className="absolute top-1/4 left-1/3 lg:left-[380px] w-1 h-1 bg-accent/60 rounded-full animate-pulse" style={{ animationDuration: '3s', animationDelay: '-1.8s', animationFillMode: 'backwards' }}>
