    ...
    <div className="fixed inset-0 pointer-events-none z-0">
      {showBubbles && (
        <>
          ...
          <div className="absolute top-12 left-8 lg:left-[290px] w-3 h-3 bg-accent/40 rounded-full animate-pulse" style={{ animationDuration: '1.8s', animationDelay: '-0.7s', animationFillMode: 'backwards' }}></div>
          
          {/* Small stars */}
          <div className="absolute top-1/4 left-1/3 lg:left-[400px] w-1 h-1 bg-accent/60 rounded-full animate-pulse" style={{ animationDuration: '3s', animationDelay: '-1.8s', animationFillMode: 'backwards' }}>
