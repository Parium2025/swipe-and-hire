        ...
        return (
          <div className="text-center space-y-8 py-8">
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <h1 className="text-8xl md:text-9xl lg:text-[12rem] font-bold text-white animate-fade-in leading-tight">
          ...
          <div className="max-w-4xl mx-auto flex justify-center items-center px-8">
            ...
            {currentStep === 0 ? (
              <Button
                onClick={handleNext}
                size="lg"
                className="px-12 py-3 text-lg hover:scale-110 transition-transform duration-200 hover:shadow-2xl -mt-24"
              >
                Kom igång
