...
const WelcomeTunnel = ({
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 0:
        return <div className="text-center space-y-0">
            <div className="space-y-6">
                {/* Removed center icon for cleaner, minimal hero */}
                <div className="h-2" />
              
              <div className="space-y-6">
                <h1 className="text-7xl sm:text-8xl md:text-8xl lg:text-9xl font-bold text-white animate-fade-in leading-tight">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-lg md:text-xl text-white max-w-md mx-auto font-normal drop-shadow-sm">Låt oss skapa din profil tillsammans
