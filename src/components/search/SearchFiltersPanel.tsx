              ...
              <DropdownMenu modal={false}>
                ...
                >
                  <DropdownMenuItem
                    ...
                    className="cursor-pointer [@media(hover:hover)]:hover:bg-white/10 active:bg-white/10 text-white font-medium flex items-center justify-between touch-manipulation py-3 md:py-2 text-[15px] md:text-sm leading-tight"
                  >
                    <span>Alla yrkesområden</span>
                    {selectedCategory === 'all-categories' && <Check className="h-4 w-4 text-white" />}
                  </DropdownMenuItem>
