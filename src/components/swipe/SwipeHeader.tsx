...
export const SwipeHeader = memo(function SwipeHeader({
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-20 grid grid-cols-[1fr_auto_1fr] items-center gap-2 px-4 pt-[env(safe-area-inset-top,0px)] pb-3">
      {/* Left: counter */}
      ...
      {hasFilter ? (
        <button
          ...
          className="relative flex items-center gap-2 h-12 px-6 rounded-full bg-white/10 border border-white/20 [@media(hover:hover)]:hover:bg-white/20 transition-colors active:scale-[0.97] touch-manipulation"
