        ...
        <div className="absolute inset-x-0 bottom-4 z-10 px-5">
          <div className="mt-4 flex items-center justify-center gap-5">
            ...
            <button
              ...
              className="w-[52px] h-[52px] rounded-full bg-[hsl(215,70%,55%)] border border-white/25 flex items-center justify-center shadow-lg shadow-[hsl(215,70%,55%)]/30 active:scale-[0.93] transition-transform touch-manipulation"
            >
