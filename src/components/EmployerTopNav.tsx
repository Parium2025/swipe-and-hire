        ...
        <div className="relative z-10 flex items-center gap-1">
          ...
          >
            ...
            {preloadedUnreadMessages > 0 && (
              <span className="absolute -top-2 left-0 bg-destructive text-destructive-foreground text-xs font-medium px-1.5 py-0.5 rounded-full min-w-[18px] text-center z-20">
                {preloadedUnreadMessages}
              </span>
            )}
          </button>
