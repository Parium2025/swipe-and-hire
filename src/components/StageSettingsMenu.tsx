    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="p-0.5 rounded-md md:hover:bg-white/20 transition-colors text-white touch-manipulation flex items-center justify-center focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0">
          ...
          <div className="flex gap-2 pt-2">
            <Button
              ...
              className={`flex-1 min-h-[44px] rounded-full transition-colors duration-150 active:scale-95 ${
                newLabel.trim() && !updateStageSetting.isPending ? 'border border-white/30' : 'border border-transparent'
              }`}
            >
              Spara
            </Button>
