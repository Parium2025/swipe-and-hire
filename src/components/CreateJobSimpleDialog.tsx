  ...
  return (
    <>
      <Dialog open={open} onOpenChange={(isOpen) => {
        ...
        <DialogContent className="bg-parium-gradient [&>button]:hidden border-none shadow-none sm:rounded-xl overflow-y-auto pb-safe fixed inset-0 left-0 top-0 h-[100dvh] w-full translate-x-0 translate-y-0 max-w-none sm:relative sm:left-1/2 sm:top-1/2 sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-md sm:h-auto sm:max-h-[90vh]">
