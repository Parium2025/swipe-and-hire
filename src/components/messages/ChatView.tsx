  ...
  return (
    <div ref={rootRef} className="flex-1 flex flex-col rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm overflow-hidden">
      ...
      <ScrollArea
        ref={scrollAreaRef}
        className={cn(
          "flex-1 px-4 pt-4 pb-1 no-chrome-pad",
      ...
      <AnimatePresence>
        {typingUsers.length > 0 && (
          <motion.div
            ...
            className="px-4 py-1 border-t border-white/5"
            role="status"
            aria-label="Den andra personen skriver"
          >
            <div className="flex items-center text-pure-white">
      ...
      {/* Input */}
      <div className="px-4 pt-2 pb-3 border-t border-white/10 flex-shrink-0">
