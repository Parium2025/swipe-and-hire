            ...
            <Card className="bg-white/[0.06] backdrop-blur-2xl border border-white/15 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.55)] rounded-2xl overflow-hidden">
              <CardContent className="p-6">
                 <Tabs value={isLogin ? 'login' : 'signup'} onValueChange={handleTabChange}>
                  <SlidingTabs idPrefix="auth-desktop" isLogin={isLogin} onTabChange={handleTabChange} />

                  {/* Forms wrapper for instant swap */}
                  <div className="relative">
                    {/* Login form - always in DOM, overlay swap */}
                    <div
                      id="auth-desktop-login-panel"
                      role="tabpanel"
                      aria-labelledby="auth-desktop-login-tab"
                      hidden={!isLogin}
                      aria-hidden={!isLogin}
                      {...(!isLogin ? { inert: '' } : {})}
                  ...
                  <div
                    id="auth-desktop-signup-panel"
                    role="tabpanel"
                    aria-labelledby="auth-desktop-signup-tab"
                    hidden={isLogin}
                    aria-hidden={isLogin}
                    {...(isLogin ? { inert: '' } : {})}
