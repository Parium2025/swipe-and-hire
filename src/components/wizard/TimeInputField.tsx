    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        <Input
          ...
          maxLength={5}
          className={`flex-1 bg-white/5 border-white/20 placeholder:text-foreground/80 h-11 text-sm focus:border-white/40 ${
            startValue ? 'text-foreground font-semibold' : 'text-foreground/80'
          }`}
        />
        ...
        <Input
          ...
          maxLength={5}
          className={`flex-1 bg-white/5 border-white/20 placeholder:text-foreground/80 h-11 text-sm focus:border-white/40 ${
            endValue ? 'text-foreground font-semibold' : 'text-foreground/80'
          }`}
        />
      </div>
    </div>
