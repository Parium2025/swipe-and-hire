      ...
      {selectedBenefits.length > 0 && (
        <div className="flex flex-wrap gap-1.5 mb-2">
          {selectedBenefits.map((benefit) => (
            <span
              key={benefit}
              className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-white/5 border border-white/20 rounded-full text-xs text-white backdrop-blur-xs"
            >
            ...
            <div className="p-2 border-t border-white/10">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="h-9 w-9 min-w-[36px] shrink-0 aspect-square bg-white/10 border border-white/20 !rounded-full text-white hover:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center"
                >
