...
const EmployerHome = memo(() => {
  ...
  return (
    <>
      ...
      <div className="space-y-3 sm:space-y-6 responsive-container-wide pb-2 sm:py-3 animate-fade-in relative z-10 [padding-top:calc(env(safe-area-inset-top,0px)+22px)] sm:[padding-top:0.75rem] [padding-bottom:calc(env(safe-area-inset-bottom,0px)+50px)]">
