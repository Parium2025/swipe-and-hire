  ...
  return (
    ...
    >
      ...
      {showCountdown && isPlaying && remainingSeconds !== null && (
        <div className="absolute top-3 right-3 md:top-3 md:right-6 px-2 py-1 bg-black/40 backdrop-blur-sm rounded-full text-white text-sm md:text-base font-bold" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.8)' }}>
          {remainingSeconds}s
        </div>
      )}
