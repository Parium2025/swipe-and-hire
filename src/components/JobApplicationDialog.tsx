        ...
        <div className="space-y-2">
          ...
          {isStandardQuestion && (
            <Input
              ...
              className="bg-white/5 border-white/20 text-white placeholder:text-white/40 hover:border-white/50"
          ...
          {!isStandardQuestion && question.question_type === 'text' && (
            <Textarea
              ...
              value={answers[question.id] || ''}
              onChange={(e) => handleAnswerChange(question.id, e.target.value)}
              className="min-h-[80px] bg-white/5 border-white/20 text-white placeholder:text-white/40 hover:border-white/50"
            />
          )}
