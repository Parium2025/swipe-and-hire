...
const MobileJobWizard = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="parium-panel max-w-none w-[min(92vw,400px)] h-auto max-h-[75vh] sm:max-h-[80vh] bg-parium-gradient text-white [&>button]:hidden p-0 flex flex-col border-none shadow-none rounded-[24px] sm:rounded-xl overflow-hidden transition-all duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] will-change-transform will-change-opacity"
      ...
      >
        ...
        <div className="flex flex-col h-full max-h-[75vh] sm:max-h-[80vh] relative z-10">
          ...
          {/* Scrollable Content */}
          <div ref={scrollContainerRef} className="flex-1 min-h-0 overflow-y-auto p-4 space-y-2 transition-all duration-150 ease-[cubic-bezier(0.4,0,0.2,1)]">
            {/* Step 1: Grundinfo */}
            {currentStep === 0 && (
