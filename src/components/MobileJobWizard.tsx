                                ...
                                {showApplicationForm && (
                                  ...
                                  >
                                    <Button
                                      ...
                                      className="sticky top-0 ml-auto -mb-9 z-30 flex h-8 w-8 rounded-full text-white transition-transform duration-200 hover:bg-transparent [@media(hover:hover)]:hover:scale-110 active:scale-95"
                                    >
                                      <X className="h-4 w-4" />
                                    </Button>
                                  ...
                                  {showDesktopApplicationForm && (
                                    <div className="absolute inset-0 overflow-y-auto overflow-x-hidden bg-card-parium p-3 custom-scrollbar overscroll-contain">
                                      <Button
                                        ...
                                        className="sticky top-0 ml-auto -mb-10 z-30 flex h-9 w-9 rounded-full text-white transition-transform duration-200 hover:bg-transparent [@media(hover:hover)]:hover:scale-110 active:scale-95"
                                      >
                                        <X className="h-4 w-4" />
                                      </Button>
                                      <JobPostingPreviewContent
