  ...
  return (
    <div className="min-w-0 flex">
      <button
        ...
        className="flex w-full min-w-0 items-center justify-center gap-1 overflow-hidden rounded-lg border border-white/20 bg-white/5 px-2 py-2 transition-all duration-200 outline-none focus:outline-none active:scale-[0.97] touch-manipulation md:py-1.5 md:hover:bg-white/10"
      >
