...
export const dialogCloseButtonClassName = "absolute right-4 top-4 z-50 flex h-7 w-7 !min-h-0 !min-w-0 shrink-0 aspect-square items-center justify-center overflow-hidden rounded-full bg-white/10 p-0 text-white transition-colors outline-none focus:outline-none focus-visible:outline-none focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 md:h-7 md:w-7 md:hover:bg-white/20 md:hover:text-white disabled:pointer-events-none"
