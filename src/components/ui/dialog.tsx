...
export const dialogCloseButtonClassName = "absolute right-4 top-4 z-50 flex h-[var(--icon-button-size-sm)] w-[var(--icon-button-size-sm)] !min-h-0 !min-w-0 shrink-0 aspect-square items-center justify-center overflow-hidden rounded-full bg-white/10 p-0 text-white transition-colors outline-hidden focus:outline-hidden focus-visible:outline-hidden focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 md:hover:bg-white/20 md:hover:text-white disabled:pointer-events-none"
