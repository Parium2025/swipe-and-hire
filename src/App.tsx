        ...
        <UnsavedChangesProvider>
          <div className="min-h-screen safe-area-content overflow-x-hidden w-full max-w-full">
            ...
            <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
              ...
              <div className="fixed top-20 left-10 w-4 h-4 bg-secondary/30 rounded-full animate-float pointer-events-none z-[1]" style={{ animationDelay: '0s' }}></div>
              <div className="fixed top-32 left-16 w-2 h-2 bg-accent/40 rounded-full animate-float pointer-events-none z-[1]" style={{ animationDelay: '0.5s' }}></div>
              <div className="fixed top-24 left-20 w-3 h-3 bg-secondary/20 rounded-full animate-float pointer-events-none z-[1]" style={{ animationDelay: '1s' }}></div>
              ...
              <div className="fixed bottom-40 right-20 w-5 h-5 bg-accent/30 rounded-full animate-float pointer-events-none z-[1]" style={{ animationDelay: '0.3s' }}></div>
              <div className="fixed bottom-32 right-16 w-3 h-3 bg-secondary/25 rounded-full animate-float pointer-events-none z-[1]" style={{ animationDelay: '0.8s' }}></div>
              <div className="fixed bottom-36 right-24 w-2 h-2 bg-accent/35 rounded-full animate-float pointer-events-none z-[1]" style={{ animationDelay: '0.2s' }}></div>
