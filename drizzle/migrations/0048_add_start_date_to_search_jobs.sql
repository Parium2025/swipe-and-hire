DROP FUNCTION IF EXISTS public.search_jobs(text, text, text, text[], text, integer, integer, integer, integer, timestamptz, uuid[], timestamptz, text, uuid, real, integer);
