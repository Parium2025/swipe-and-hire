-- SÄKERHET: privilegium (egen organisation + admin-roll) får bara delas ut
-- när e-postadressen är bekräftad. Vid registrering skapas bara profil och
-- samtyckeslogg. Organisationen skapas i stället i bekräftelsesteget
-- (confirm-email) för vanliga registreringar — eller här direkt om kontot
-- redan är bekräftat vid infogningen (t.ex. auto-confirm-flöden).
...
BEGIN
  ...
  IF v_role = 'employer' THEN
    ...
    -- Egen organisation + grundande administratör — ENDAST för bekräftad e-post.
